...
class Config:
    ...
    max_length: int = 32              # Контекстное окно: было 4, стало 32               # Размер контекстного окна
    stride: int = 2                   # Шаг скольжения окна
    batch_size: int = 4               # Размер пакета для обучения
    ...
    num_epochs: int = 300              # Количество эпох обучения
